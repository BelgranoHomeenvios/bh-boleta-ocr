    ...
    modalDescuento() {
      ...
      const pintar = () => {
        ...
        caja.innerHTML = `
          ...
          <div class="vgrp"><div class="vlbl">${d.modo === 'pct' ? 'Porcentaje' : 'Monto'}</div>
            <div class="vcant"><input id="dd-valor" type="number" min="0" ${d.modo === 'pct' ? 'max="100"' : ''} value="${d.valor}" placeholder="0">
              <span class="muted">${d.modo === 'pct' ? '%' : '$'}</span></div></div>
          <div class="vpre">
        ...
        val.oninput = () => { d.valor = val.value; pintar(); };
