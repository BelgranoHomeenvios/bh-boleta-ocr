  ...
  const Presupuesto = {
    ...
    pintarProductos() {
      ...
      cont.innerHTML = `
        ...
        <div class="srow">
          <div class="lcant">${this.cantHTML(this.cantNueva, 'nueva')}</div>
          <div class="bwrap">
    ...
    estilos() {
      return `<style>
        ...
        .srow{display:grid;grid-template-columns:62px minmax(0,1.6fr) auto;gap:8px;align-items:center;padding:11px 0 4px}
