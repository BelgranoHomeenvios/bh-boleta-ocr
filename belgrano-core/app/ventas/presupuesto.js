  ...
  const Presupuesto = {
    ...
    estilos() {
      return `<style>
        ...
        .srow{display:grid;grid-template-columns:56px minmax(0,1.6fr) auto;gap:8px;align-items:center;padding:10px 0}
        ...
        .lhead,.lrow{display:grid;grid-template-columns:56px minmax(0,1.6fr) 92px 104px 112px 112px 24px;gap:8px;align-items:center;padding:0}
        ...
        .lobs{padding:0 0 11px 64px;display:flex;flex-direction:column;gap:7px}
        ...
        @media(max-width:1000px){.lhead{display:none}.lrow{grid-template-columns:56px 1fr 1fr;gap:8px}.lrow .sub,.lrow .lock,.lrow .pnum{text-align:left}}
